...
from vllm.model_executor.layers.sparse_attn_indexer import (
    SparseAttnIndexer,
    sparse_attn_indexer_prefill_chunk,
)
...
class Indexer(nn.Module):
    ...
    def run_prefill_chunk(
        ...
        return sparse_attn_indexer_prefill_chunk(
            ...
            total_seq_lens=self.max_total_seq_len,
    ...
    def forward(
        ...
        q_fp8, k, weights = self.prepare_sparse_inputs(
            hidden_states,
            qr,
            positions,
            rotary_emb,
